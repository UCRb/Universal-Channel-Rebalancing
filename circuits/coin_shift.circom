...
//         msgHasher[i].inputs[0] <== msg[0];
//         msgHasher[i].inputs[1] <== msg[1];
//         msgHasher[i].inputs[2] <== msg[2];
...
component main {public[enabled, message, pubX, pubY, S, e]} = verifyKeySchnorrGroup(4);
